...
export default function LogoIcon(props: LogoIconProps) {
  return (
    <Icon viewBox="0 0 36 36" {...props}>
      ...
      <path
        fill="#FFE8B6"
        d="M29 21h4.896C33.156 13.11 28.118 7 22 7c-6.627 0-12 7.164-12 16 0 2.123.317 4.146.88 6H29v-8z"
      />
      <path
        fill="#FFAC33"
        d="M36 23c0-8.836-5.373-16-12-16-6.626 0-12 7.164-12 16 0 2.123.317 4.146.88 6H30c3.314 0 6-2.685 6-6z"
      />
      <path fill="#FFAC33" d="M6 23h10v6H6z" />
      <path
        fill="#FFE8B6"
        d="M0 23c0-3.312 2.687-6 6-6s6 2.687 6 6c0 3.315-2.687 6-6 6s-6-2.685-6-6z"
      />
      <path
        fill="#FFAC33"
        d="M14 7C7.374 7 2 14.164 2 23c0 2.21 1.791 4 4 4s4-1.79 4-4c0-6.963 3.342-12.871 8-15.069C16.747 7.339 15.405 7 14 7z"
      />
      ...
      <path
        fill="#F4900C"
        d="M20 12c0 .552-.447 1-1 1-.552 0-1-.448-1-1s.448-1 1-1c.553 0 1 .448 1 1z"
      />
